...
local jdtls_path = 'C:/Users/elbaklyf/bin/jdt-language-server-1.39.0-202408291433'
...
local config = {
  ...
  cmd = {
    ...
    "-javaagent:" .. "C:/Users/elbaklyf/bin/lombok.jar",
    "-jar", launcher_jar,
    "-configuration", vim.fs.normalize(jdtls_path .. '/' .. get_config_dir()),
    "-data", vim.fn.expand('~/.cache/jdtls-workspace/') .. workspace_dir
  },
  settings = {
    ['java.format.settings.url'] = vim.fn.expand("~/java-formatter.xml")
  },
